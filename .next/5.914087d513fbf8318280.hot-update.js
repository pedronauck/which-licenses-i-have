...
Object(__WEBPACK_IMPORTED_MODULE_1_react_emotion__["a" /* default */])('table', {
  target: "ek9g6vf2"
})("width:500px;padding:0;table-layout:auto;background-color:transparent;border-spacing:0;border-collapse:collapse;border-style:hidden;border-radius:5px;& thead th{text-align:center;font-weight:400;font-size:16px;opacity:0.5;padding:20px 20px;border-bottom:1px dashed white;}& tbody td{padding:12px 20px;line-height:2;font-weight:200;}& tbody > tr{display:table-row;border-top:white;}");
...
//# sourceMappingURL=5.914087d513fbf8318280.hot-update.js.map