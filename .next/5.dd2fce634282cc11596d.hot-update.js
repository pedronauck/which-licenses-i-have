...
var Table =
/*#__PURE__*/
Object(__WEBPACK_IMPORTED_MODULE_1_react_emotion__["a" /* default */])('table', {
  target: "ek9g6vf2"
})("width:500px;padding:0;table-layout:auto;background-color:transparent;border-spacing:0;border-collapse:collapse;border-style:hidden;border-radius:5px;& thead th{text-align:center;font-weight:400;font-size:16px;opacity:0.5;padding:0 20px 10px 20px;border-top:1px dotted white;border-bottom:1px dotted white;}& tbody td{padding:12px 20px;line-height:2;font-weight:200;}& tbody > tr{display:table-row;border-top:white;}");
var Licences = function Licences(_ref) {
  ...
  }, "licence"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("th", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 65
    }
  ...
  }, "some name"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("td", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 71
    }
  }, "other thing"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("td", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 72
    }
...
//# sourceMappingURL=5.dd2fce634282cc11596d.hot-update.js.map